...
Ideally, the installed thirds party packages should be the versions that are given the requirements file. If the requirements file is updated, you can use the following command to update your installation:
...
To update the test scripts, make sure you are inside the virtual environment:
